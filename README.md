...
<img src = "https://github.com/Thomashighbaugh/salut-rs/blob/main/.github/assets/default.png" alt ="default appearance of the command when run" width = "960px">
<img src = "https://github.com/Thomashighbaugh/salut-rs/blob/main/.github/assets/1.png" alt ="a variant appearance of the command when run" width = "960px">
